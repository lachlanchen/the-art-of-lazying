...
- [networking](./networking/README.md): practical home-lab networking notes, including Astrill Lazy Router native Windows onboarding, Pi Wi-Fi-to-LAN routing, and workstation default-route switching.
...
- [remote-desktop](./remote-desktop/README.md): Windows access bootstrapping with RDP/OpenSSH/UU Remote, plus GNOME native RDP vs XRDP stability notes for Ubuntu 24.04.
