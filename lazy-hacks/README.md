...
- [baidunetdisk-freeze-fix](./baidunetdisk-freeze-fix/README.md): promote a verified signed 8.5.8 client and prevent its floating-window right-click deadlock without patching Baidu binaries.
